...
public class MyAdapter2 extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    private MyAdapter2.OnItemClickListener mOnItemClickListener = null;

    //define interface
    public static interface OnItemClickListener {
        void onItemClick(View view , int position);
    }
    public MyAdapter2(Context context, List<Bean.RetBean.ListBean.ChildListBean> listBeans) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.adapter_item2, null);
        MyAdapter2.MyHolder holder = new MyAdapter2.MyHolder(view);
